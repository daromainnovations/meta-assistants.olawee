...
exports.chatHandlerService = exports.ChatHandlerService = void 0;
...
class ChatHandlerService {
     ...
     */
    async processMessage(provider, messageData, systemContext) {
        ...
        try {
            ...
            const model = ai_provider_service_1.aiProviderService.getModel(provider, messageData.model);
            // 2. Obtener Tools Base Dinámicas e Inyectarlas al Modelo
            const tools = tool_executor_service_1.toolExecutorService.getTools();
            const modelWithTools = model.bindTools(tools);
            // 3. Obtener Context Session (Memoria) desde Database usando Prisma
            const history = await memory_service_1.memoryService.getChatHistory(idUserChat);
            ...
            if (!finalDocumentContext) {
                finalDocumentContext = await memory_service_1.memoryService.getDocumentContext(idUserChat);
            }
...
`;
            ...
            if (finalSystemPrompt) {
                ...
                messages.push(new messages_1.SystemMessage(finalSystemPrompt));
            }
            ...
            await memory_service_1.memoryService.saveMessage(idUserChat, 'human', userMessageContent);
            ...
            await memory_service_1.memoryService.saveMessage(idUserChat, 'ai', aiResponseContent);
...
exports.ChatHandlerService = ChatHandlerService;
// Singleton de Inversión de control base
exports.chatHandlerService = new ChatHandlerService();
